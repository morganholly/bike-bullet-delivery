...
@onready var marker_front_wheel_ground: Marker3D = $"marker front wheel ground"
@onready var marker_back_wheel_ground: Marker3D = $"marker back wheel ground"
@onready var marker_up: Marker3D = $"marker up"
